...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        'template_qz2xwp9',
        {
          ...
          to_email: "manit.garg.in@gmail.com",
 ...
 const openLinkedInProfile = () => {
    window.open("https://www.linkedin.com/in/manitgarg/", "_blank");
  };
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Manit, love the website! I'd like to chat about some opportunities you might like! 🎉"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <button
          ...
          <label className="flex flex-col">
            <p className="text-center" style={{ color: "#7C7E80" }}>
              Manit Garg's Portfolio <br />
              Credits for Design and Development to
